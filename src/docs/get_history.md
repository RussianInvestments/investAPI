...
### Интерфейс загрузки исторических данных
На [странице](https://russianinvestments.github.io/invest-history-index-ui/#/) доступен интерфейс получения истории по инструменту.
Есть поиск по тикеру и фильтр по типу инструмента. Доступны прямые ссылки, а также автоматически сгенерированный скрипт для выгрузки.
Для получения исторических данных потребуется ввести [токен доступа](https://russianinvestments.github.io/investAPI/token).
