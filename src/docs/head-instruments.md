...
Метод [getAssetFundamentals](/investAPI/instruments/#getassetfundamentals) возвращает показатели компании по активу.
Обычно обновление данных происходит на следующий рабочий день после публикации, в редких случаях это может занять более недели.
